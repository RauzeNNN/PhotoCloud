...
public class profileViewPage extends JFrame {
	
	/*
	 * Same with profilePage but this page has a go back button with different code.
	 * it just disposes.
	 */
	...
	public profileViewPage(User user, DataPack datapack) {  //posts mean totalposts
